...
inline bool box_compare(const Hitable::CPtr a, const Hitable::CPtr b, int axis) {
    AABB box_a;
    AABB box_b;
...
bool box_x_compare(const Hitable::CPtr a, const Hitable::CPtr b) {
    return box_compare(a, b, 0);
}

bool box_y_compare(const Hitable::CPtr a, const Hitable::CPtr b) {
    return box_compare(a, b, 1);
}

bool box_z_compare(const Hitable::CPtr a, const Hitable::CPtr b) {
    return box_compare(a, b, 2);
}

BVH::BVH(Hittable_list& list, size_t start, size_t end, float time0, float time1)
{
...
bool BVH::hit(CppUtil::Basic::Ptr<Ray> ray, float t_min, float t_max, Hit_record& rec) const
{
...
bool BVH::boundingBox(float t0, float t1, AABB& output_box) const
{
    output_box = box;
    return true;
}