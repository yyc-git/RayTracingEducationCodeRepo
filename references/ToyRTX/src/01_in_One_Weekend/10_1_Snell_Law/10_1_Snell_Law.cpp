...
int main(int argc, char ** argv) {
	...
	world.add(ToPtr(new Sphere(vec3(0.0f, 0.0f, -1.0f), 0.5f, ToPtr(new Refraction(1.5f, 0.7f, 0.3f, 0.3f)))));
	world.add(ToPtr(new Sphere(vec3(1.1f, 0.0f, -1.0f), 0.5f,ToPtr(new Refraction(1.5f, 0.8f,0.8f,0.8f)))));
