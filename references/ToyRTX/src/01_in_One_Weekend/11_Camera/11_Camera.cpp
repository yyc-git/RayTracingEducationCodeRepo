...
int main(int argc, char ** argv) {
	...
	world.add(ToPtr(new Sphere(vec3(0.0f, 0.0f, -1.0f), 0.5f, ToPtr(new Refraction(1.5f, 0.98f, 0.98f, 0.98f)))));
	world.add(ToPtr(new Sphere(vec3(0.0f, 0.0f, -1.0f), -0.48f, ToPtr(new Refraction(1.5f, 0.98f, 0.98f, 0.98f,0.02f)))));
	world.add(ToPtr(new Sphere(vec3(1.1f, 0.0f, -1.0f), 0.5f, ToPtr(new Lambertian(0.1f, 0.2f, 0.5f)))));
	...
	Camera::Ptr camera = ToPtr(new Camera(vec3(-2.0f, 2.0f, 1.0f), vec3(0.0f, 0.0f, -1.0f), vec3(0.0f, 1.0f, 0.0f), 45.0f, aspect_ratio));
